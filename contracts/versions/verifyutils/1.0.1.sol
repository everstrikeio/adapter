...
library VerifyUtils {
    ...
    function verify_signature(string memory input, uint256 nonce, bytes memory signature, address signer) public pure returns (bool) {
        bytes32 input_hash = keccak256(abi.encodePacked(input, nonce));
